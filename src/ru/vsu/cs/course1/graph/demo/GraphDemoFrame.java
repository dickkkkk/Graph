...
public class GraphDemoFrame extends JFrame {
    ...
    private JButton buttonSearcObshVershin;
    ...
    private JSpinner spinnerNeedVertex;
    ...
    public GraphDemoFrame() {
        ...
        buttonSearcObshVershin.addActionListener(e -> {
            if (graph == null) {
                return;
            }
            showSystemOut(() -> {
                int from = (int) spinnerFromVertex.getValue();
                int need = (int) spinnerNeedVertex.getValue();
                final boolean[] first = {true};
                GraphAlgorithms.solution(graph, from, need);
            });
        });
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        textAreaGraphFile.setText("7 8 0 1 0 2 1 3 2 3 3 4 3 5 4 6 5 6");
        ...
        buttonSearcObshVershin = new JButton();
        buttonSearcObshVershin.setText("Поиск общих вершин");
        panel5.add(buttonSearcObshVershin, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 1, false));
        ...
        spinnerNeedVertex = new JSpinner();
        panel4.add(spinnerNeedVertex, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(60, -1), null, 0, false));
